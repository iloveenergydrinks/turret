...
contract TurretRecoverableStakingForkTest is Test {
    function testRealTokenAndExistingPoolRevenueOnFork() public {
        ...
        vm.createSelectFork(rpc, vm.envOr("STAKING_FORK_BLOCK", uint256(58901354)));
        ...
        TurretRecoverableFeeRouter router = new TurretRecoverableFeeRouter(token, usdg, treasury, pools);
        TurretRecoverableStaking staking = router.staking();
        vm.prank(holder); ILegacyStake(0x8E6DfB3e8AB41754F766062fF279E2463057bf47).unstake(100e18);
        ...
        assertEq(router.totalRecovered(), available);
        assertEq(staking.earned(holder), rewards);
