...
contract MemecoinBatchV3ForkTest is Test {
    ...
    function setUp() public {
        ...
        assertEq(assets.length, 17);
        assertEq(holders.length, assets.length);
    ...
    function testAIActualEscrowLifecycle() public { _exerciseAsset(0); }
    function testZZZActualEscrowLifecycle() public { _exerciseAsset(1); }
    function testCHUMPActualEscrowLifecycle() public { _exerciseAsset(2); }
    function testBONERActualEscrowLifecycle() public { _exerciseAsset(3); }
    function testPIPEDOGActualEscrowLifecycle() public { _exerciseAsset(4); }
    function testUBIKActualEscrowLifecycle() public { _exerciseAsset(5); }
    function testMOOActualEscrowLifecycle() public { _exerciseAsset(6); }
    function testTENDIESActualEscrowLifecycle() public { _exerciseAsset(7); }
    function testHMMActualEscrowLifecycle() public { _exerciseAsset(8); }
    function testIFActualEscrowLifecycle() public { _exerciseAsset(9); }
    function testSHROOMActualEscrowLifecycle() public { _exerciseAsset(10); }
    function testJUGGERNAUTActualEscrowLifecycle() public { _exerciseAsset(11); }
    function testROBINActualEscrowLifecycle() public { _exerciseAsset(12); }
    function testASTEROIDActualEscrowLifecycle() public { _exerciseAsset(13); }
    function testFRONGActualEscrowLifecycle() public { _exerciseAsset(14); }
    function testMICRODUCKActualEscrowLifecycle() public { _exerciseAsset(15); }
    function testYOLOActualEscrowLifecycle() public { _exerciseAsset(16); }
