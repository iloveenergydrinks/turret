...
| --- | --- | --- |
| Brand | Original Dockyard mark made from parallel dock lines and a wave cut, with Qubic Grid wordmark | Semantic inline SVG |
...
| Raster assets | None required; the world is deliberately semantic, vector, and GPU-rendered | Accepted omission |
