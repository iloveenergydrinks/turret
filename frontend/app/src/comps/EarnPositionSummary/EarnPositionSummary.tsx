      ...
      subtitle={
        <>
          ...
          <InfoTooltip heading="Total Value Locked (TVL)">
            Total rUSD deposited in this Stability Pool.
          </InfoTooltip>
        </>
      }
      infoItems={[
        {
          ...
          content: (
            <>
              <div
                title={active
                  ? `${fmtnum(earnPosition?.deposit, "full")} rUSD`
                  : undefined}
                className={css({
                  display: "flex",
              ...
              {prevEarnPosition && (
                <div
                  title={`${fmtnum(prevEarnPosition.deposit, "full")} rUSD`}
                  className={css({
                    display: "flex",
                    justifyContent: "flex-start",
                    alignItems: "center",
            ...
            active
              ? (
                <>
                  <HFlex
                    gap={4}
                    title={`${fmtnum(earnPosition?.rewards.bold, "full")} rUSD`}
                    className={css({
