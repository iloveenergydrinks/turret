  ...
  function FooterInfoSlippageRefundClose(props: {
    ...
    return (
      <Field.FooterInfo
        ...
        value={
          <HFlex gap={4}>
            <Amount prefix="~" value={props.slippageProtection} suffix=" rUSD" />
            <InfoTooltip heading="Slippage refund">
              To allow for slippage, slightly more of your {props.collateralName}{" "}
              will be converted to rUSD than needed for repayment. The remaining rUSD will be refunded to your wallet.
              The actual amount may be higher or lower than indicated here, according to the execution price of your
              trade.
            </InfoTooltip>
          </HFlex>
        }
      ...
      <Field.FooterInfo
        ...
        value={
          <HFlex gap={4}>
            ...
            <InfoTooltip heading="Slippage refund">
              To allow for slippage, slightly more rUSD will be converted to {collateralName}{" "}
