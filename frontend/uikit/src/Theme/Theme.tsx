...
export const lightTheme = {
  ...
  colors: {
    ...
    dimmed: "gray:400",
    fieldBorder: "#E8E7F2",
    fieldBorderFocused: "#B7B2F3",
    fieldSurface: "#FAFAFF",
    focused: "#5A50E8",
    focusedSurface: "#EEECFF",
    focusedSurfaceActive: "#E1DEFF",
    strongSurface: "#11142F",
    ...
    secondary: "#EEECFF",
    secondaryActive: "#DDD9FF",
    secondaryContent: "#5A50E8",
    secondaryHint: "#E6E3FF",
    selected: "#5A50E8",
    separator: "#F5F4FF",
    surface: "white",
    tableBorder: "#E3E3F1",
