...
import {SingleSourceCreditBase} from "./SingleSourceCreditBase.sol";
...
contract TurretCreditEngine is SingleSourceCreditBase {
    ...
    constructor(Config memory c, address signer) SingleSourceCreditBase(c) {
