> **Turret documentation:** Read [docs.turret.capital](https://docs.turret.capital) for Borrow, Earn, P2P loans, Portfolio, rates and risks. [Documentation source](docs/gitbook/README.md) · [Publishing instructions](deploy/docs/README.md). The reference below describes the inherited Liquity subsystem.
