"""Apply only the risk-monitor and risk-watchdog service settings; never reads/writes service secrets.
...
redeploy each service. The existing keeper, frontend and borrower-alert services are untouched.
"""
import argparse
import json
import pathlib
